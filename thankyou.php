...
<html>
	...
	<body>
		...
		<div id="container">
      	...
      	<div id="content">
      		<div class="thanks">Thank you very much<br> for installing Formspider!</div>
      		<!--<div id="title">
					Thank you very much for installing Formspider!
				</div>-->
      		<img src="images/gergersuccess_960.jpg"></img>
      		<div class="linkToFormspider">Go to <a style="color:#d46200;" href="http://theformspider.com">theformspider.com</a></div>
				<p>
					The entire office is erupting with joy and cheers. The developers are hugging each other in tears of happiness. 
					Champagne, music and dancing... Let the party begin! 
					Today is the day, you installed Formspider. We shall never forget it and remember it in our hearts. <br/>
					<strong>Thank you, thank you very much!</strong> <br> <br>
