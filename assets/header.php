	...
	<div id="header">
		...
		<ul id="nav">
			...
			<li<? if($page == 'blog'): ?> class="active" <? endif ?>><a href="http://theformspider.com/test/blog">Blog</a></li>
			<li<? if($page == 'about-us'): ?> class="active"<? endif ?>><a href="http://theformspider.com/test/about-us.php">About us</a></li>
		<ul>
	</div><!-- /header -->
