<div id="header">
	...
	<ul id="nav">
		<li<? if($page == 'index'): ?> class="active"<? endif ?>><a href="http://localhost:8888/formspider/index.php">Home</a></li>
		<li<? if($page == 'product'): ?> class="active"<? endif ?>><a href="http://localhost:8888/formspider/product.php">Product</a></li>	
