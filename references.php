...
<body class="references">
	...
	<div id="content" class="clearfix">
		...
		<h2>References</h2>
		<p>With customers in 28 countries, Formspider is the choice of Oracle Developers worldwide to build the applications of tomorrow.</p>
		...
		<ul>
			...
			<li class="end-of-row">
				<img id="ridex" src="images/references/ridexlogo.jpg" width="440" height="200" alt="Ridex">
				<h3>Ridex</h3>
				<p>Formspider continues to create new opportunities for freelancers, IT Consulting Firms and ISV’s around the world. There is nothing more pleasing for us than hearing stories of IT companies succeeding with Formspider. Ridex Ltd. from Russia, is one of them.
				<a class="readmore" href="http://theformspider.com/blog/2015/10/19/ridex-succeeds-with-formspider/">Read more &rarr;</a></p>
			</li>
