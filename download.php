...
<script type="text/javascript" >
	$(document).ready(function() {
		...
		var $dialog = $('<div id="systemRequirementsDialog"></div>')
			...
			.dialog({
				autoOpen: false,
				title: 'Formspider 1.5.0 Installation Requirements',
				width:600
			});
		...
		function logDownload(name, email) {
			...
			$.ajax({
			  type: "GET",
			  url: "product.php",
			  data: "descid=Download&name="+ name +"&mail="+ email+"&version=1.5.0",
			  async: true,
					...
					<form id="downloadForm" class="cmxform" method="get" action="">
						...
						<div style="width: 100%; height:450px;">
							...
							<div class="download-block">
								<p class="download-title"> Formspider Desktop 1.5.0</p>
