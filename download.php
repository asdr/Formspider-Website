...
<script type="text/javascript" >
	$(document).ready(function() {
		...
		var $dialog = $('<div id="systemRequirementsDialog"></div>')
			...
			.dialog({
				autoOpen: false,
				title: 'Formspider 1.8.0 Installation Requirements',
				width:600
			});
		...
		$( "#downloadWindows" )
			...
			.click(function() {
				if(checkForm(nameField, emailField)) {
					downloadURL("http://cdn.theformspider.com/cdn/Formspider_1.8.0.zip");
		...
		$( "#downloadLinux" )
			...
			.click(function() {
				if(checkForm(nameField, emailField)) {
					downloadURL("http://cdn.theformspider.com/cdn/Formspider_1.8.0.jar");
					logDownload(nameField.value, emailField.value);
		...
		function logDownload(name, email) {
			...
			$.ajax({
			  type: "GET",
			  url: "product.php",
			  data: "descid=Download&name="+ name +"&mail="+ email+"&version=1.8.0",
			  async: true,
					...
					<form id="downloadForm" class="cmxform" method="get" action="">
						...
						<div style="width: 100%; height:450px;">
							...
							<div class="download-block">
								<p class="download-title"> Formspider Desktop 1.8.0</p>
