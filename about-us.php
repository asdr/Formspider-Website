...
<body class="about-us">
	...
	<div id="content" class="clearfix">
		...
		<ul id="list-of-people">
			<li>
				<a href="#"><img src="images/about/yalim.png" width="70" height="70" alt="Yalim Gerger">
				<h3>Yalim Gerger</h3>
				<h4>Founder/CEO</h3></a>
			...
			<li>
				<a href="#"><img src="images/about/samet.png" width="70" height="70" alt="Samet Başaran">
				<h3>Samet Başaran</h3>
			...
			<li>
				<a href="#"><img src="images/about/ibrahim.png" width="70" height="70" alt="İbrahim Sandallı">
			...
			<li>
				<a href="#"><img src="images/about/asdr.png" width="70" height="70" alt="Serdar Gökçen">
				<h3>Serdar Gökçen</h3>
				<h4>Software Engineer in Test</h3></a>
			...
			<li>
				<a href="#"><img src="images/about/asli.png" width="70" height="70" alt="Aslı Gerger">
				<h3>Aslı Gerger</h3>
