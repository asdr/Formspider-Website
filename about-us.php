...
<body class="about-us">
	...
	<div id="content" class="clearfix">
		...
		<ul id="list-of-people">
			<li>
				<a><img src="images/about/yalim.png" width="70" height="70" alt="Yalim Gerger">
				<h3>Yalim Gerger</h3>
				<h4>Founder/CEO</h3></a>
			...
			<li>
				<a href="#"><img src="images/about/orhan.png" width="70" height="70" alt="Orhan Turkoğlu">
			...
			<li id="danieltin">
				<a><img src="images/about/danieltin.jpg" width="70" height="70" alt="Daniel Tin">
				<h3>Daniel Tin</h3>
			...
			<li>
				<a href="#"><img src="images/about/ugur.png" width="70" height="70" alt="Uğur Koçak">
				<h3>Uğur Koçak</h3>
			...
			<li id="oskansavli">
				<a><img src="images/about/oskan.png" width="70" height="70" alt="Öskan Şavlı">
				<h3>Öskan Şavlı</h3>
			...
			<li>
				<a><img src="images/about/ibrahim.png" width="70" height="70" alt="İbrahim Sandallı">
			...
			<li id="serdargokcen">
				<a><img src="images/about/asdr.png" width="70" height="70" alt="Serdar Gökçen">
				<h3>Serdar Gökçen</h3>
				<h4>Software Engineer in Test</h3></a>
			...
			<li id="suataaldan">
				<a><img src="images/about/suataldan.jpg" width="70" height="70" alt="Suat A. Aldan">
				<h3>Suat A. Aldan</h3>
				<h4>Front-end Engineer</h3></a>
			...
			<li id="orhanarikan">
				<a><img src="images/about/orhanarikan.jpg" width="70" height="70" alt="Orhan Arıkan">
				<h3>Orhan Arıkan</h3>
				<h4>Software Engineer in Test</h3></a>
			...
			<li>
				<a><img src="images/about/asli.png" width="70" height="70" alt="Aslı Gerger">
				<h3>Aslı Gerger</h3>
